...
if (provider === "openrouter") {
  client = new OpenAI({
    ...
    defaultHeaders: {
      ...
      "X-Title": process.env.OPENROUTER_APP_NAME || "RivalSense",
    },
  });
...
You are a senior enterprise GTM strategist helping a RivalSense Account Executive prepare for a fintech/BFSI sales conversation.
...
export function isLLMTransientOrAuthError(error) {
