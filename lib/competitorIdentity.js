...
const IDENTITY_MAP = {
  razorpay: {
    ...
    summary: "Fast integration. Governance and reconciliation decide the long game.",
    pricing: "Developer convenience versus enterprise cost control",
    product: "Integration depth versus edge-case control",
    proof: "Uptime, docs quality, and settlement discipline",
    risk: "Operational scale risk",
    opening: "What breaks first when your payment volume and exception count rise?",
    uniqueNarrative: "Razorpay usually wins on onboarding friction, then gets judged on how well it handles scale, control, and reconciliation.",
  },
  paytm: {
    archetype: "mass-distribution merchant network",
    tension: "brand familiarity versus merchant trust depth",
    summary: "Distribution is broad. Merchant trust and operational confidence decide enterprise fit.",
    pricing: "Brand comfort versus blended commercial cost",
    product: "Merchant reach versus support consistency",
    proof: "Support response, settlement clarity, and regulatory confidence",
    risk: "Trust and compliance risk",
    opening: "Which part of the current setup matters more: reach or merchant control?",
    uniqueNarrative: "Paytm often enters with familiarity, but larger buyers need proof that the merchant experience stays consistent under pressure.",
  },
  phonepe: {
    archetype: "upi-led merchant payments platform",
    tension: "distribution scale versus monetization control",
    summary: "Acceptance is wide. Monetization and edge-case control decide the enterprise decision.",
    pricing: "Acceptance scale versus commercial discipline",
    product: "Distribution breadth versus workflow control",
    proof: "UPI reach, support consistency, and exception handling",
    ...
    uniqueNarrative: "PhonePe tends to win on broad acceptance, then gets evaluated on whether its operating model stays tight when buyers push on control and cost.",
  },
  trustly: {
    archetype: "open-banking and A2A rail",
    tension: "authentication simplicity versus settlement certainty",
    summary: "Open-banking reach helps. Authentication and reconciliation decide trust.",
    pricing: "A2A convenience versus settlement confidence",
    product: "Auth flow reliability versus reconciliation depth",
    proof: "PSD2 posture, settlement handling, and auth failure handling",
    ...
    uniqueNarrative: "Trustly needs to prove that the convenience of account-to-account payment does not create reconciliation surprises or flow failures at scale.",
  },
};
